...
namespace LearnLink.Migrations
{
    ...
    [Migration("20260522021301_EnterpriseBackup")]
    partial class EnterpriseBackup
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LearnLink.Models.AccountDeletionFeedback", b =>
                {
                    ...
                    b.ToTable("AccountDeletionFeedbacks");
                });
            ...
            modelBuilder.Entity("LearnLink.Models.ArchivedResource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LearnLink.Models.BackupItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<double>("StorageSizeMb")
                        .HasColumnType("float");
                    ...
                    b.ToTable("BackupItems");
                });

            modelBuilder.Entity("LearnLink.Models.BackupPolicy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("NotifyOnBackup")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("LearnLink.Models.BackupRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LearnLink.Models.LessonComment", b =>
                {
                    b.Property<int>("LessonCommentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("LessonCommentId"));
            ...
            modelBuilder.Entity("LearnLink.Models.Resource", b =>
                {
                    ...
                    b.Property<bool>("EnableVersionHistory")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("IsSharedCrossSchool")
                        .HasColumnType("bit");

                    b.Property<bool>("ModerateComments")
                        .HasColumnType("bit");

                    b.Property<DateTime?>("PendingReviewPreviewedAt")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<bool>("RequireVersionNotes")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("LearnLink.Models.RestoreOperation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LearnLink.Models.School", b =>
                {
                    ...
                    b.Property<bool>("AllowCrossSchoolSharing")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("LearnLink.Models.SchoolSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LearnLink.Models.ArchivedResource", b =>
                {
                    b.HasOne("LearnLink.Models.ApplicationUser", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("LearnLink.Models.BackupItem", b =>
                {
                    b.HasOne("LearnLink.Models.BackupRecord", "BackupRecord")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("LearnLink.Models.BackupPolicy", b =>
                {
                    b.HasOne("LearnLink.Models.ApplicationUser", "LastUpdatedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("LearnLink.Models.BackupRecord", b =>
                {
                    b.HasOne("LearnLink.Models.ApplicationUser", "TriggeredByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("LearnLink.Models.LessonComment", b =>
                {
                    b.HasOne("LearnLink.Models.LessonLearned", "Lesson")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("LearnLink.Models.RestoreOperation", b =>
                {
                    ...
                    b.HasOne("LearnLink.Models.ApplicationUser", "RestoredByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("LearnLink.Models.SchoolSettings", b =>
                {
                    b.HasOne("LearnLink.Models.School", "School")
                        .WithOne("Settings")
                        .HasForeignKey("LearnLink.Models.SchoolSettings", "SchoolId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
